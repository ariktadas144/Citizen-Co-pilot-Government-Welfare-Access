  ...
  try {
    ...
    const data: OcrExtractedData = {
      ...
      address: parsed.address
        ? {
            line1: ((parsed.address as Record<string, string>).line1 as string) || null,
            line2: ((parsed.address as Record<string, string>).line2 as string) || null,
            city: ((parsed.address as Record<string, string>).city as string) || null,
            district: ((parsed.address as Record<string, string>).district as string) || null,
            state: ((parsed.address as Record<string, string>).state as string) || null,
            pincode: ((parsed.address as Record<string, string>).pincode as string) || null,
          }
        : null,
    };
